namespace NServiceBus.SagaPersisters
{
    ...
    public static class ConfigureAzureSagaStorage
    {
        ...
        /// </summary>
        public static PersistenceExtentions<NServiceBus.AzureStoragePersistence, StorageType.Sagas> ConnectionString(this PersistenceExtentions<NServiceBus.AzureStoragePersistence, StorageType.Sagas> config, string connectionString)
        {
        ...
        /// </summary>
        public static PersistenceExtentions<NServiceBus.AzureStoragePersistence, StorageType.Sagas> CreateSchema(this PersistenceExtentions<NServiceBus.AzureStoragePersistence, StorageType.Sagas> config, bool createSchema)
        {
