...
public class When_participating_in_saga_conversations_with_outbox_enabled : NServiceBusAcceptanceTest
{
    ...
    public class EndpointWithSagaThatWasMigrated : EndpointConfigurationBuilder
    {
        ...
        class ProvidePartitionKeyBasedOnSagaIdBehavior(IProvidePartitionKeyFromSagaId providePartitionKeyFromSagaId)
        ...
        public class CustomSaga(Context testContext) : Saga<CustomSagaData>, IAmStartedByMessages<StartSagaMessage>, IAmStartedByMessages<ContinueSagaMessage>
        {
        ...
        public class ContinueMessageHandler(Context testContext) : IHandleMessages<ContinueSagaMessage>
        {
            public Task Handle(ContinueSagaMessage message, IMessageHandlerContext context)
            {
